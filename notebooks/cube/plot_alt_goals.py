...
default_results = sorted(glob.glob('results/cube/gbfs/default_goal/'+'learned-v0.4/*.pickle'))
random_results = sorted(glob.glob('results/cube/gbfs/random_goal/'+'learned-v0.4/*.pickle'))
