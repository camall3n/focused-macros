...
for k in tqdm(range(1,n)):
    for trial in tqdm(range(n_trials)):
        ...
        def djikstra(start, debug_fn=None):
            ...
            results = astar.search(start, is_goal, step_cost, heuristic, get_successors, max_transitions=1e9, debug_fn=debug_fn, quiet=True)
