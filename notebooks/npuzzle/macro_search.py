...
#%% Run the search
search_results = search.astar(
    startpuz, is_goal, step_cost, heuristic, get_successors, args.max_transitions, args.save_best_n)

#%% Save the results
results_dir = 'results/macros/npuzzle/'
os.makedirs(results_dir, exist_ok=True)
with open(results_dir+'macro-{}-results.pickle'.format(tag), 'wb') as f:
