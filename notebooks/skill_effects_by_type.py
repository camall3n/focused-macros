...
option_names = ['primitive actions', 'expert skills', 'random skills', 'generated skills v0.2']
...
for i,option_type in enumerate(option_types):
    ...
    plt.scatter(lengths, effects, c='C{}'.format(i), marker=marker_styles[i], facecolor='none', s=50, label=option_names[i])
